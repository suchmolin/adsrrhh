    ...
    <div className="w-full h-[800px] sm:h-[700px] md:h-[600px] flex justify-center items-center  relative">
      ...
      <div className="w-[290px] xs:w-[370px] sm:w-[630px] md:w-[760px] lg:w-[1030px] xl:w-[1250px] h-full flex flex-col justify-center relative sm:px-10">
        <div className="relative w-fit ml-1 flex items-center">
          <div className="w-[80px] aspect-square relative mr-5 sm:-mt-52 md:mt-0">
            <Image
          ...
          <h1 className="w-[290px] xs:w-[260px] sm:w-[430px] text-3xl xs:text-4xl sm:text-6xl font-bold leading-none mt-5 sm:-mt-52 md:-mt-2 text-azuloscuroads text-center sm:text-start font-[monserrat-bold] bg-[url('/img/lineaverde.png')] bg-bottom bg-no-repeat bg-contain pb-5 sm:pb-9">
            {" "}
