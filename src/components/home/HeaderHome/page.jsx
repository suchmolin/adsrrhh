    ...
    <div className="w-full h-[700px] flex justify-center items-center bg-gradient-to-r from-white to-gray-200 relative">
      ...
      <div className="w-[290px] xs:w-[370px] sm:w-[630px] md:w-[760px] lg:w-[1030px] xl:w-[1250px] h-full flex flex-col justify-center relative sm:px-10">
        <div className="relative w-fit ml-1">
          ...
          <h1 className="w-[360px] sm:w-[550px] CTextShadow text-4xl xs:text-4xl sm:text-7xl font-bold leading-none -mt-32 md:-mt-10 text-azuloscuroads text-center sm:text-start font-[monserrat-bold]">
            Oportunidades que te conectan
            <span className="text-azulads block">con el éxito</span>
          </h1>
          <BiSolidQuoteRight className="absolute bottom-0 sm:-bottom-10 right-10 sm:right-24 text-azulads/20 text-4xl sm:text-7xl" />
        </div>
