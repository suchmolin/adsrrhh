...
export default function RegCandidatoModal({ regExitoso, partner_name }) {
  return (
    <Modal show={regExitoso}>
      <Modal.Body>
        ...
        <p className="text-xl text-gray-700  text-center">
          Gracias {partner_name} por participar en nuestro proceso de
          pre-registro. Serás notificado cuando tengamos vacantes disponibles
        </p>
