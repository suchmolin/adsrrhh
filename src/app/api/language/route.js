...
export async function POST(request) {
  try {
    ...
    console.log("Language data received:", body)
    ...
    console.log("Saving language at:", url)
    ...
    console.log("Language saved successfully:", json)
...
export async function DELETE(request) {
  try {
    ...
    console.log("Deleting language at:", url)
    ...
    const json = await response.json()
    console.log("Language deleted successfully:", json)
