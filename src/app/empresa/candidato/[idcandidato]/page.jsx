...
import { hasValidEmpresaSession, getSessionToken } from "@/utils/cookies"
...
export default function VerPerfilCandidato({ params }) {
    ...
    <NoSSR>
      ...
      <ClientOnly fallback={
        ...
        {!sessionChecked ? (
          ...
          <div className="w-full flex flex-col justify-center items-center py-10 bg-gray-50 relative overflow-hidden pt-40" suppressHydrationWarning>
            ...
            <div className="w-[290px] xs:w-[370px] sm:w-[630px] md:w-[760px] lg:w-[1030px] xl:w-[1250px] flex flex-wrap justify-center" suppressHydrationWarning>
              <div className="w-11/12 sm:w-10/12 md:w-5/12 flex justify-center sm:px-8 pb-10 sm:pb-20 md:pb-52" suppressHydrationWarning>
                <CardPerfilCandidato jobSeekerData={jobSeekerData} candidatoId={idcandidato} readOnly={true} />
              </div>
              <div className="w-11/12 sm:w-10/12 md:w-7/12 flex justify-center sm:px-7" suppressHydrationWarning>
                <CardPerfilEducacion jobSeekerData={jobSeekerData} candidatoId={idcandidato} readOnly={true} />
              </div>
            </div>
          </div>
        )}
